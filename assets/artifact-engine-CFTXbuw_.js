...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ss(e,t,n){return new ga({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ko,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(){return new ga({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new ga({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
	...
	`}var ds=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};lu.BlurDirectionX=new K(1,0),lu.BlurDirectionY=new K(0,1);var uu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},du=class extends $l{constructor(){super(),this.isOutputPass=!0,this.uniforms=pa.clone(uu.uniforms),this.material=new _a({name:uu.name,uniforms:this.uniforms,vertexShader:uu.vertexShader,fragmentShader:uu.fragmentShader}),this._fsQuad=new nu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Pt.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},fu=Math.PI*2;function pu(n){let r=new Y;n.add(r);let i=[],a=t.map((t,n)=>{let a=2.25-n*.38,o=new va({color:t.color,metalness:.8,roughness:.26,emissive:t.color,emissiveIntensity:.1}),s=new zr({color:t.color,transparent:!0,opacity:.6,toneMapped:!1}),c=new Y;r.add(c);let l=new Z(new oa(a,.035,10,160),o);c.add(l);let u=new Z(new oa(a-.09,.008,6,160),s);c.add(u);let d=new ci(new Ri(.015,.075,.035),o,60),f=new wn;for(let e=0;e<60;e++){let t=e/60*fu;f.position.set(Math.sin(t)*a,Math.cos(t)*a,.026),f.rotation.set(0,0,-t),f.scale.set(1,e%5?.6:1.3,1),f.updateMatrix(),d.setMatrixAt(e,f.matrix)}c.add(d);let p=new Z(new ta(.105),new zr({color:t.color,toneMapped:!1}));p.position.set(0,a,.09),p.scale.set(.75,1.2,.75),c.add(p);let m=new Z(new oa(a,.02,6,32,.22),s);m.rotation.z=Math.PI/2,c.add(m);let h=new Y;r.add(h);let g=Et.degToRad(e[n]);h.position.set(Math.sin(g)*a,Math.cos(g)*a,.04),h.rotation.z=-g;let _=new Z(new oa(.155,.014,6,32),s);h.add(_);let v=new Z(new Ri(.012,.42,.01),s);h.add(v);let y=new Z(new oa(a,.16,6,96),new zr({transparent:!0,opacity:0,depthWrite:!1}));y.userData.ringIndex=n,r.add(y),i.push(y);let b=new zr({color:t.color,transparent:!0,opacity:0,toneMapped:!1,blending:2,depthWrite:!1}),x=new Z(new oa(a,.045,6,48,fu*.16),b);x.position.z=.12,r.add(x);let S=new Z(new oa(a,.014,6,144),b);S.position.z=.14,r.add(S);let C=new zr({color:t.color,transparent:!0,opacity:.12,toneMapped:!1,blending:2,depthWrite:!1}),w=new ci(new ia(.036,6,6),C,24);for(let e=0;e<24;e++){let t=e/24*fu;f.position.set(Math.sin(t)*a,Math.cos(t)*a,.065),f.rotation.set(0,0,0),f.scale.setScalar(1),f.updateMatrix(),w.setMatrixAt(e,f.matrix)}return c.add(w),{rotor:c,marker:p,material:o,lineMaterial:s,target:h,pulseMaterial:b,sweep:x,wave:S,lightsMaterial:C,age:1/0,wasLocked:!1}});return{group:r,hits:i,reset(){a.forEach(e=>{e.age=1/0,e.wasLocked=!1})},update(t,n,i,o){if(r.visible=t.mode===`calibration`||t.mode===`syncing`,a.forEach((e,n)=>{t.locked[n]&&!e.wasLocked&&r.visible&&(e.age=0),(!t.locked[n]||!r.visible)&&(e.age=1/0),e.wasLocked=t.locked[n],e.age+=o}),!r.visible)return 0;let s=t.mode===`syncing`?t.syncElapsed/8:0,c=0;return a.forEach((r,a)=>{let o=a===t.selectedRing,l=t.locked[a],u=s<.7?s*s*24:.7*.7*24;r.rotor.rotation.z=-Et.degToRad(t.angles[a])+(i?0:u*(a%2?-1:1)),r.rotor.rotation.x=i?0:Math.sin(Math.min(s,.7)*Math.PI)*(a-1)*.6,r.rotor.position.z=Math.min(s,.7)*(a-1)*.35;let d=r.age<2.4?Math.sin(Math.min(1,r.age/.16)*Math.PI*.5)*Math.exp(-r.age*1.25):0;r.material.emissiveIntensity=(l?.45+s:o?.2:.04)+d*(i?.2:.8),r.lineMaterial.opacity=l||o?.9:.3,r.lightsMaterial.opacity=l?.55+d*.45:o?.2:.07,r.sweep.visible=r.wave.visible=d>0&&!i,r.pulseMaterial.opacity=d*.85,r.sweep.rotation.z=Math.PI/2-Et.degToRad(e[a])-Math.min(r.age/1.1,1)*fu,r.wave.scale.setScalar(1-Et.clamp((r.age-.5)/1.15,0,1)*.75),c=Math.max(c,r.age<2.4?Math.exp(-(((r.age-1.2)*3.5)**2)):0),r.target.visible=s<.05,r.marker.scale.setScalar(l?1.25:o&&!i?1.1+Math.sin(n*2.2)*.12:.85)}),c},ringAt(e){return e.intersectObjects(i,!1)[0]?.object.userData.ringIndex}}}function mu(e){let t=new Y;e.add(t),t.visible=!1;let n=6281,r=()=>(n=n*16807%2147483647,(n-1)/2147483646),i=9e3,a=new Float32Array(i*3),o=new Float32Array(i*3);for(let e=0;e<i;e++){let t=r()*fu,n=1.4+r()**1.7*5.2;a.set([Math.cos(t)*n,Math.sin(t)*n,(r()-.5)*(.25+n*.19)],e*3),o.set([r(),r(),r()],e*3)}let s=new Dr;s.setAttribute(`position`,new fr(a,3)),s.setAttribute(`aTraits`,new fr(o,3));let c=new ga({uniforms:{uTime:{value:0},uPointer:{value:new K},uReveal:{value:0},uPixelRatio:{value:1}},transparent:!0,depthWrite:!1,blending:2,vertexShader:`attribute vec3 aTraits;uniform float uTime;uniform vec2 uPointer;uniform float uReveal;uniform float uPixelRatio;varying vec3 vColor;varying float vAlpha;
      void main(){float r=length(position.xy);float a=atan(position.y,position.x)+uTime*(.045+.16/r);vec3 p=vec3(cos(a)*r,sin(a)*r,position.z);
      p.z+=sin(a*3.+r*2.-uTime*.2)*(.12+r*.065);vec2 d=p.xy-uPointer*3.;p.xy+=d/(dot(d,d)+.8)*.32;
      p.xy*=.7+.3*uReveal;p.z+=sin(a*2.+uTime*.08)*.4;
      vec4 mv=modelViewMatrix*vec4(p,1.);gl_Position=projectionMatrix*mv;
      gl_PointSize=clamp((1.2+aTraits.x*2.8)*uPixelRatio*10./-mv.z,1.,6.);
      vColor=mix(vec3(.35,.68,1.),vec3(.77,.4,1.),aTraits.y);vColor=mix(vColor,vec3(1.,.87,.65),pow(aTraits.z,7.));
      vAlpha=(.3+aTraits.x*.6)*uReveal;}`,fragmentShader:`varying vec3 vColor;varying float vAlpha;void main(){float d=length(gl_PointCoord-.5);if(d>.5)discard;float a=pow(1.-d*2.,1.5)*vAlpha;gl_FragColor=vec4(vColor*1.4,a);}`}),l=new ji(s,c);l.rotation.set(.38,-.2,-.3),t.add(l);let u=new Y;t.add(u);let d=new zr({color:10723583,transparent:!0,opacity:.6,toneMapped:!1,blending:2,depthWrite:!1});for(let e=0;e<4;e++){let t=new Z(new sa(1.72+e*.22,.008+(e===0?.005:0),480,5,2,3),d);t.rotation.set(e*.33,e*.25,e*.8),u.add(t)}let f=new ga({uniforms:{uTime:c.uniforms.uTime,uReveal:c.uniforms.uReveal},transparent:!0,side:2,depthWrite:!1,blending:2,vertexShader:`varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`uniform float uTime;uniform float uReveal;varying vec2 vUv;void main(){vec2 p=vUv-.5;float r=length(p);float a=atan(p.y,p.x);float edge=exp(-abs(r-.29)*110.);float halo=exp(-abs(r-.29)*17.)*.17;float threads=(sin(a*9.+r*40.-uTime*.25)*.5+.5);vec3 col=mix(vec3(.25,.45,1.),vec3(.82,.55,1.),threads);gl_FragColor=vec4(col,(edge+halo)*uReveal*.85);}`}),p=new Z(new na(8.4,8.4),f);p.position.z=-.45,t.add(p);let m=new Y;m.position.z=.3,t.add(m);let h=new Y;m.add(h);let g=new Y;m.add(g);let _=new pi({color:16764806,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1}),v=new pi({color:12166399,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1}),y=(e,t)=>new xi(new Dr().setFromPoints(e),t);for(let e=-2;e<=2;e++)h.add(y([new q(-3.4,e*.34,0),new q(3.4,e*.34,0)],_));[-2.7,-.9,.9,2.7].forEach(e=>h.add(y([new q(e,-1.2,0),new q(e,1.2,0)],_)));for(let e=0;e<5;e++){let t=new Ji([new q(-.15,-.15,0),new q(-1.1+e*.55,.4+e*.08,0),new q((e-2)*.85,1.35+e%2*.55,0),new q((e-2)*1.2,2.7+e%3*.28,0)]);g.add(y(t.getPoints(48),v))}let b=0;return{group:t,setQuality(e,t){s.setDrawRange(0,e===`high`?i:3500),c.uniforms.uPixelRatio.value=t},update(e,n,r,i,a,o,s,l){if(t.visible=e,!e)return;c.uniforms.uTime.value=a?0:r,c.uniforms.uReveal.value=n,o||c.uniforms.uPointer.value.lerp(i,a?.04:.08),d.opacity=n*.42,b+=(+!!l-b)*(1-Math.exp(-s*3.5)),h.visible=l===`order`&&b>.01,g.visible=l===`choice`&&b>.01,_.opacity=b*.72,v.opacity=b*(a?.72:.58+Math.sin(r*2.2)*.16);let f=.72+b*.28;m.scale.setScalar(f),m.rotation.z=l===`choice`&&!a?Math.sin(r*.18)*.12:0,u.rotation.set(.2,l===`order`||a?0:r*.025,l===`order`||a?0:r*.035),t.rotation.y=a?0:Math.sin(r*.07)*.08}}}var hu=Math.PI*2,gu=Et.clamp;function _u(e,t,n,r){let i=e.position-t,a=e.velocity+n*i,o=Math.exp(-n*r);e.position=t+(i+a*r)*o,e.velocity=(e.velocity-n*a*r)*o}function vu(e,t,n){let r={value:0},i={value:new X(15182934)};for(let e of n)e.onBeforeCompile=e=>{e.uniforms.uDissolve=r,e.uniforms.uAshColor=i,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
varying vec3 vMetalPosition;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
vMetalPosition = transformed;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying vec3 vMetalPosition; uniform float uDissolve; uniform vec3 uAshColor;`).replace(`#include <clipping_planes_fragment>`,`#include <clipping_planes_fragment>
          float erosion = fract(sin(dot(floor(vMetalPosition * 58.), vec3(127.1, 311.7, 74.7))) * 43758.5453);
          if (uDissolve > .001 && erosion < uDissolve) discard;`).replace(`#include <opaque_fragment>`,`outgoingLight += uAshColor * (1. - smoothstep(0., .045, abs(erosion - uDissolve))) * uDissolve * 1.6;
          #include <opaque_fragment>`)},e.customProgramCacheKey=()=>`chronos-metal-dissolve-v3`,e.needsUpdate=!0;let a=21013,o=()=>(a=a*16807%2147483647,(a-1)/2147483646),s=7500,c=new Float32Array(s*3),l=new Float32Array(s*3),u=new Float32Array(s);for(let e=0;e<s;e++){let t=e%5,n=o()*hu,r=o()*hu,i=(t===0?2.55:2.24-(t-1)*.29)+Math.cos(r)*.06;c.set([Math.cos(n)*i,Math.sin(n)*i,Math.sin(r)*.06],e*3),l.set([o(),o(),o()],e*3),u[e]=t}let d=new Dr;d.setAttribute(`position`,new fr(c,3)),d.setAttribute(`aTraits`,new fr(l,3)),d.setAttribute(`aPart`,new fr(u,1));let f=t.map(()=>new Xt),p=new ga({uniforms:{uFrames:{value:f},uAmount:{value:0},uEra:{value:0},uTime:{value:0},uColor:i,uRatio:{value:1}},transparent:!0,blending:2,depthWrite:!1,vertexShader:`attribute vec3 aTraits;attribute float aPart;uniform mat4 uFrames[5];uniform float uAmount;uniform float uEra;uniform float uTime;uniform float uRatio;varying float vAlpha;varying vec3 vTint;
      void main(){vec3 p=(uFrames[int(aPart)]*vec4(position,1.)).xyz;float spread=uAmount*(.3+aTraits.x*1.25);float a=atan(p.y,p.x);
      p.xy+=vec2(cos(a+uTime*.16+aTraits.y*3.),sin(a+uTime*.16+aTraits.y*3.))*spread;
      p.z+=(aTraits.z-.5)*spread*3.;p.y+=sin(uTime*.45+aTraits.x*6.)*spread*.24;
      float photon=smoothstep(1.2,2.,uEra);p.xy+=vec2(-sin(a),cos(a))*sin(uTime*.5+aTraits.y*10.)*photon*.18;
      vec4 mv=modelViewMatrix*vec4(p,1.);gl_Position=projectionMatrix*mv;
      gl_PointSize=clamp((1.+aTraits.x*2.3)*uRatio*10./-mv.z,1.,5.);
      vAlpha=clamp(uAmount*1.5,0.,1.)*(.35+aTraits.x*.6);vTint=mix(vec3(1.,.76,.4),vec3(.7,.55,1.),clamp(uEra*.5,0.,1.));}`,fragmentShader:`uniform vec3 uColor;varying float vAlpha;varying vec3 vTint;void main(){float d=length(gl_PointCoord-.5)*2.;if(d>1.)discard;gl_FragColor=vec4(mix(vTint,uColor,.5)*1.6,pow(1.-d,1.5)*vAlpha);}`}),m=new ji(d,p);e.add(m);let h=new Y;e.add(h);let g=new zr({color:11772415,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1});for(let e=0;e<6;e++){let t=new Z(new oa(1.48+e*.19,.009,5,144,hu*.83),g);h.add(t)}return{setQuality(e,t){d.setDrawRange(0,e?2700:s),p.uniforms.uRatio.value=t},reset(){r.value=0,p.uniforms.uAmount.value=0},update(e,n,a,o,s){let c=e-Math.floor(e),l=Math.sin(c*Math.PI)**2,u=Et.smoothstep(e,1.25,2),d=o||!a?0:Math.max(l*.92,u*.64);return r.value=d,i.value.copy(s),m.visible=a&&!o&&d>.005,h.visible=a&&u>.005,p.uniforms.uAmount.value=d,p.uniforms.uEra.value=e,p.uniforms.uTime.value=n,t.forEach((e,t)=>{e.updateMatrix(),f[t].copy(e.matrix)}),g.opacity=u*(o?.35:.75),h.children.forEach((t,r)=>t.rotation.set(r*.5+e*.15,r*.68+n*(r%2?-.045:.06),r*.6+n*.09)),d}}}function yu(e){let t=new Y;e.add(t),t.visible=!1;let n=new zr({color:13678591,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1}),r=new ci(new Ri(.025,.15,.025),n,96);t.add(r);let i=new zr({color:13549055,transparent:!0,opacity:0,blending:2,depthWrite:!1,toneMapped:!1}),a=new Z(new na(.012,5),i);t.add(a);let o=new wn;return{update(e,s){let c=gu((e-5.65)/2.35,0,1);if(t.visible=c>0&&e<8&&!s,!t.visible)return 0;let l=Et.smoothstep(c,.2,1),u=Math.sin(c*Math.PI);n.opacity=Math.min(1,c*5)*(1-l*.3),i.opacity=u*.85,a.scale.x=1+l**3*150,a.rotation.z=-.14,a.scale.y=.8+l*.4;for(let e=0;e<96;e++){let t=e/96,n=t*hu,i=2.5+Math.sin(t*19)*.12,a=(t-.5)*5.6;o.position.set(Et.lerp(a,Math.cos(n)*i,l),Et.lerp(-2.45,Math.sin(n)*i,l),Math.sin(n*3)*l*.6),o.rotation.set(l*n*.25,l*Math.sin(n),-n*l),o.scale.set(1+l*.6,(e%8?.55:1.6)*(1+l),1),o.updateMatrix(),r.setMatrixAt(e,o.matrix)}return r.instanceMatrix.needsUpdate=!0,l}}}function bu(e){let t=4.5,n=new Y;e.add(n),n.visible=!1;let r=Array.from({length:64},()=>({position:new q,born:-100,chain:-1})),i=new Float32Array(192),a=new Float32Array(64),o=new Dr;o.setAttribute(`position`,new fr(i,3).setUsage(Ve)),o.setAttribute(`aAlpha`,new fr(a,1).setUsage(Ve));let s=new ga({uniforms:{uRatio:{value:1}},transparent:!0,depthWrite:!1,blending:2,vertexShader:`attribute float aAlpha;uniform float uRatio;varying float vAlpha;void main(){vAlpha=aAlpha;vec4 mv=modelViewMatrix*vec4(position,1.);gl_Position=projectionMatrix*mv;gl_PointSize=(4.+aAlpha*3.)*uRatio;}`,fragmentShader:`varying float vAlpha;void main(){float r=length(gl_PointCoord-.5)*2.;if(r>1.)discard;gl_FragColor=vec4(.85,.78,1.,pow(1.-r,1.4)*vAlpha);}`});n.add(new ji(o,s));let c=new Float32Array(768),l=new Float32Array(256),u=new Dr;u.setAttribute(`position`,new fr(c,3).setUsage(Ve)),u.setAttribute(`aAlpha`,new fr(l,1).setUsage(Ve));let d=new ga({transparent:!0,depthWrite:!1,blending:2,vertexShader:`attribute float aAlpha;varying float vAlpha;void main(){vAlpha=aAlpha;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`varying float vAlpha;void main(){gl_FragColor=vec4(.62,.57,.92,vAlpha*.65);}`});n.add(new Ti(u,d));let f=0,p=0,m=0,h=null,g=-1,_=!1,v=!1;function y(){h=null,m++}function b(){r.forEach(e=>{e.born=-100}),p=0,f=0,g=-1,y()}return{reset:b,breakStroke:y,setQuality(e,t){_=e,s.uniforms.uRatio.value=t},update(e,s,d,x,S){if(!e&&v&&b(),n.visible=e,v=e,!e)return 0;if(x===0)return y(),r.filter(e=>f-e.born<t).length;f+=x;let C=h?.distanceTo(s)??1/0;if(d&&f-g>(_?.09:.055)&&C>.16){C>1.7&&y();let e=r[p];e.position.copy(s),e.position.z=.8,e.born=f,e.chain=m,p=(p+1)%64,h=s.clone(),g=f}let w=0,T=0;for(let e=0;e<64;e++){let n=r[e],o=f-n.born,s=o<t?(1-o/t)**1.5:0;if(i.set([n.position.x,n.position.y,n.position.z],e*3),a[e]=s*(S?.75:.85+Math.sin(o*2)*.15),s){w++;for(let i=1;i<=(_?1:2);i++){let a=r[(e-i+64)%64];if(a.chain!==n.chain||a.born>=n.born||f-a.born>=t||a.position.distanceTo(n.position)>1.5)continue;let o=T*6;c.set([n.position.x,n.position.y,n.position.z,a.position.x,a.position.y,a.position.z],o),l[T*2]=s,l[T*2+1]=(1-(f-a.born)/t)**1.5,T++}}}return o.attributes.position.needsUpdate=!0,o.attributes.aAlpha.needsUpdate=!0,u.setDrawRange(0,T*2),u.attributes.position.needsUpdate=!0,u.attributes.aAlpha.needsUpdate=!0,o.computeBoundingSphere(),u.boundingSphere=new yr(new q,50),w}}}var xu=Math.PI*2;function Su(e,t){return e.transparent=!0,e.opacity=t,e.depthWrite=!1,e.userData.storyOpacity=t,e}function Cu(e,t){return new xi(new Dr().setFromPoints(e),t)}function wu(e,t=!1){let n=new Y,r=Su(new va({color:e,emissive:e,emissiveIntensity:t?1.1:.2,metalness:.35,roughness:.5}),t?.9:.68),i=new Z(new zi(.11,.17,.62,7),r);i.position.y=.32;let a=new Z(new ia(.14,10,8),r);a.position.y=.78;let o=new Z(new zi(.035,.045,.48,6),r);return o.position.set(.18,.5,0),o.rotation.z=-.62,n.add(i,a,o),{group:n,arm:o}}function Tu(e,t){let n=new Z(new zi(3.5,3.62,.08,64,1,!0),Su(new va({color:t,metalness:.72,roughness:.38}),.24));n.position.y=-2.5,e.add(n);let r=new Z(new oa(3.52,.018,6,128),Su(new zr({color:t,toneMapped:!1}),.34));r.rotation.x=Math.PI/2,r.position.y=-2.44,e.add(r)}function Eu(){let e=new Y;Tu(e,13211992);let t=Su(new va({color:7758407,metalness:.22,roughness:.82}),.46),n=Su(new va({color:12618831,emissive:7159314,emissiveIntensity:.18,metalness:.72,roughness:.34}),.7);for(let n=0;n<7;n++){let r=Et.lerp(-2.6,-.54,n/6),i=new Z(new zi(.12,.17,1.75,8),t);i.position.set(Math.cos(r)*3.18,-1.58,Math.sin(r)*1.4-.55),e.add(i);let a=new Z(new Ri(.42,.12,.38),t);a.position.set(i.position.x,-.66,i.position.z),e.add(a)}let r=new Y;r.position.set(0,.75,-1.3),e.add(r);let i=new Z(new oa(1.5,.025,7,96),n);r.add(i);let a=new Z(new oa(1.12,.012,6,96),n);a.rotation.set(.68,.2,.1),r.add(a);let o=Su(new Ei({color:16764025,size:.075,sizeAttenuation:!0,blending:2,toneMapped:!1}),.78),s=new Float32Array([-1.18,.32,.08,-.72,.82,.05,-.18,.54,.12,.2,1.03,.02,.68,.58,.09,1.12,.9,.04,.84,.05,.08,.22,-.2,.12]),c=new Dr;c.setAttribute(`position`,new fr(s,3)),r.add(new ji(c,o));let l=Su(new pi({color:15907167,blending:2,toneMapped:!1}),.35),u=Cu([new q(-1.18,.32,.08),new q(-.72,.82,.05),new q(-.18,.54,.12),new q(.2,1.03,.02),new q(.68,.58,.09),new q(1.12,.9,.04),new q(.84,.05,.08),new q(.22,-.2,.12),new q(-.18,.54,.12)],l);r.add(u);let d=wu(14068331,!0);d.group.position.set(-2.75,-2.42,.35),d.group.scale.setScalar(.9),e.add(d.group);let f=Su(new pi({color:16767370,blending:2,toneMapped:!1}),0),p=Cu([new q(.95,2.1,-1.1),new q(0,0,0)],f);return e.add(p),{group:e,starMap:r,observerArm:d.arm,beamMaterial:f,constellationMaterial:l}}function Du(){let e=new Y;Tu(e,6932664);let t=Su(new zr({color:9298899,wireframe:!0,toneMapped:!1}),.42),n=Su(new zr({color:9298899,blending:2,toneMapped:!1}),.58),r=[];[-2.75,2.75].forEach((i,a)=>{let o=new Y;o.position.set(i,-.35+a*.35,-.75),o.rotation.y=a?-.32:.32;let s=new Z(new na(1.3,1.8,4,6),t);o.add(s);let c=new Z(new Ri(.82,.035,.015),n);c.position.set(0,.65,.02),o.add(c),e.add(o),r.push(o)});let i=new Y;e.add(i);let a=new Z(new oa(3.05,.018,6,128),n);i.add(a);let o=new Z(new Ri(5.6,.022,.025),n);i.add(o);let s=new Z(new ra(.5,.54,48),n);s.position.z=.25,i.add(s);let c=new Y;e.add(c);for(let e=0;e<3;e++){let t=new Z(new ta(.16,0),n),r=e/3*xu;t.position.set(Math.cos(r)*3.2,Math.sin(r)*1.25,-.35),c.add(t)}let l=wu(10216407,!0);return l.group.position.set(-3.18,-2.43,.1),l.group.scale.setScalar(.78),e.add(l.group),{group:e,frames:r,scanner:i,scanBar:o,reticle:s,drones:c,receiver:l.group}}function Ou(){let e=new Y;Tu(e,9402587);let t=Su(new va({color:7891368,emissive:7163364,emissiveIntensity:.22,metalness:.82,roughness:.24}),.52),n=Su(new zr({color:12100607,blending:2,toneMapped:!1}),.55),r=new Y;e.add(r);for(let e=0;e<20;e++){let i=e/20*xu,a=2.15+e%3*.5,o=.55+e*17%9*.16,s=new Z(new Ri(.22+e%2*.12,o,.28),t);s.position.set(Math.cos(i)*a,-2.45+o/2,Math.sin(i)*.95-.65),s.rotation.y=-i,r.add(s);let c=new Z(new Ri(.12,.025,.13),n);c.position.set(s.position.x,s.position.y+o/2+.04,s.position.z),r.add(c)}let i=new Y;i.position.y=1.55,e.add(i);for(let e=0;e<3;e++){let t=new Z(new oa(2.5+e*.28,.015,6,128,xu*(.64+e*.08)),n);t.rotation.set(1.06+e*.26,e*.55,e*1.4),i.add(t)}let a=new Y;e.add(a);for(let e=0;e<6;e++){let t=wu(9274293);t.group.scale.setScalar(.38),t.group.position.set(-2.15+e*.72,-2.43,.2+e%2*.24),a.add(t.group)}let o=wu(15848349,!0);o.group.scale.setScalar(.55),o.group.position.set(3,-2.43,.4),e.add(o.group);let s=Su(new pi({color:11771135,blending:2,toneMapped:!1}),.58),c=[],l=new Y;l.position.z=.55,e.add(l);let u=new q(3.02,-1.98,0);[-2.2,-.9,.6,2].forEach((e,t)=>{let n=Su(new pi({color:9732072,blending:2,toneMapped:!1}),.34),r=new $i(u,new q(1.8,-.7+t*.45,0),new q(-2.7,e,0));l.add(Cu(r.getPoints(44),n)),c.push(n)});let d=Cu(new $i(u,new q(1.35,-1.7,0),new q(0,-.35,0)).getPoints(52),s);return l.add(d),{group:e,city:r,orbital:i,citizens:a,last:o.group,routeMaterial:s,alternativeMaterials:c}}function ku(e){let t=new Y;t.position.set(0,.05,-1.05),e.add(t);let n=Eu(),r=Du(),i=Ou(),a=[n.group,r.group,i.group];t.add(...a);let o=0,s=0;function c(e,t){e.visible=t>.008,e.traverse(e=>{let n=e;n.material&&(Array.isArray(n.material)?n.material:[n.material]).forEach(e=>{let n=e;typeof n.opacity==`number`&&(n.opacity=(e.userData.storyOpacity??1)*t)})})}return{group:t,reset(e=0){o=Math.max(0,Math.min(2,Math.round(e))),s=0},update(e,l,u,d,f){if(t.visible=d,!d)return{era:o,age:s};let p=Math.max(0,Math.min(2,Math.round(e)));p!==o&&(o=p,s=0),s+=u;let m=a.map((t,n)=>Math.max(0,1-Math.abs(e-n)));a.forEach((e,t)=>c(e,m[t]));let h=f?8:s;n.starMap.rotation.z=f?0:l*.06+Math.min(h/6,1)*.28,n.observerArm.rotation.z=-.62-Et.smoothstep(h,2.2,5.2)*.72,n.beamMaterial.opacity=(n.beamMaterial.userData.storyOpacity??1)*m[0]*Et.smoothstep(h,2.8,4.8)*(f?.55:.48+Math.sin(l*5)*.24),n.constellationMaterial.opacity=.18*m[0]+Et.smoothstep(h,1.5,4)*.42*m[0],r.frames.forEach((e,t)=>{e.position.y=-.35+t*.35+(f?0:Math.sin(l*.65+t)*.12)}),r.scanner.rotation.z=f?0:-l*.14,r.scanBar.position.y=Et.lerp(2.1,-2.05,(Math.sin(h*.72)+1)/2),r.reticle.scale.setScalar(.88+Et.smoothstep(h,2,4)*.4+(f?0:Math.sin(l*3)*.04)),r.drones.rotation.z=f?.4:l*.24,r.receiver.rotation.y=f?0:Math.sin(l*.4)*.12;let g=Et.smoothstep(h,2.5,6.2);i.alternativeMaterials.forEach((e,t)=>{e.opacity=(.3+t*.025)*m[2]*(1-g)}),i.routeMaterial.opacity=(.28+g*.7)*m[2],i.orbital.rotation.y=f?0:l*.035*(1-g),i.city.rotation.y=f?0:l*.008*(1-g),i.citizens.children.forEach((e,t)=>{e.rotation.y=f?0:Math.sin(Math.min(h,5)*.5+t)*.08});let _=Et.smoothstep(h,5.2,9.2);return i.last.position.set(Et.lerp(3,.95,_),Et.lerp(-2.43,-1.2,_),.4),i.last.rotation.z=_*-.18,t.rotation.y=f?0:Math.sin(l*.04)*.025,{era:o,age:s}}}}var Au=Math.PI*2;function ju(e,t,n,r,i){let a;try{a=new Yl({antialias:!0,alpha:!1,powerPreference:`high-performance`})}catch{return i(`Браузер не смог запустить 3D. Включи аппаратное ускорение или открой сайт в другом браузере.`),{dispose(){},reset(){},setQuality(){}}}e.appendChild(a.domElement),a.setClearColor(1052687),a.toneMapping=4,a.toneMappingExposure=.82;let o=new Nn;o.fog=new Mn(1052687,.022);let s=new to(38,1,.1,80);s.position.set(0,.1,13.5);let c=new ns(a),l=new Xl,u=c.fromScene(l,.08);o.environment=u.texture,l.dispose(),c.dispose();let d=new ou(a),f=new su(o,s),p=new lu(new K(1,1),.28,.4,1.9),m=new du,h=new ru({uniforms:{tDiffuse:{value:null},uProgress:{value:0},uCenter:{value:new K(.61,.62)},uAspect:{value:1},uStrength:{value:0},uFracture:{value:0}},vertexShader:`varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`uniform sampler2D tDiffuse;uniform float uProgress;uniform vec2 uCenter;uniform float uAspect;uniform float uStrength;uniform float uFracture;varying vec2 vUv;
      void main(){vec2 d=vUv-uCenter;d.x*=uAspect;float r=length(d);float radius=uProgress*.9;float wave=exp(-pow((r-radius)*18.,2.))*sin(uProgress*3.14159);vec2 dir=normalize(d+vec2(.0001));dir.x/=uAspect;vec2 offset=dir*wave*.015*uStrength;
      float split=sin(uFracture*3.14159)*.014;offset.x+=sign(d.x+d.y*.14)*split*exp(-r*1.4);
      vec4 col=texture2D(tDiffuse,vUv-offset);col.r=texture2D(tDiffuse,vUv-offset*1.3).r;col.b=texture2D(tDiffuse,vUv-offset*.7).b;col.rgb+=vec3(.15,.11,.3)*wave*.2*uStrength;gl_FragColor=col;}`});d.addPass(f),d.addPass(p),d.addPass(h),d.addPass(m);let g=new va({color:11044433,metalness:.94,roughness:.3,envMapIntensity:1.25}),_=new va({color:13872233,metalness:.85,roughness:.24}),v=new va({color:2763044,metalness:.92,roughness:.35}),y=new zr({color:13019254,transparent:!0,opacity:.64}),b=new zr({color:16764533,toneMapped:!1}),x=new zr({color:11184878,transparent:!0,opacity:0}),S=new ro(16758620,6,8,2);o.add(S);let C=new oo(16769720,2.2);C.position.set(-3,4,6),o.add(C);let w=new oo(10201527,1.8);w.position.set(5,1,-2),o.add(w);let T=new oo(11367754,.8);T.position.set(-3,-4,2),o.add(T);let E=new Y;o.add(E);let D=pu(E),O=mu(E),k=yu(E),A=bu(E),j=ku(E),ee=new Y;E.add(ee),ee.rotation.set(-.17,.2,-.25);let M=new wn;function N(e,t,n,r,i=Au){let a=new Z(new oa(e,t,8,192,i),n);return r.add(a),a}let P=new Y;ee.add(P),N(2.64,.056,g,P),N(2.47,.045,g,P),N(2.59,.014,_,P).position.z=.066,N(2.51,.012,_,P).position.z=.066;let F=new ci(new Ri(.034,.115,.08),g,144),te=new ci(new Ri(.012,.074,.013),y,120);for(let e=0;e<144;e++){let t=e/144*Au;M.position.set(Math.sin(t)*2.555,Math.cos(t)*2.555,0),M.rotation.set(0,0,-t),M.scale.set(1,e%12==0?1.7:1,1),M.updateMatrix(),F.setMatrixAt(e,M.matrix)}for(let e=0;e<120;e++){let t=e/120*Au;M.position.set(Math.sin(t)*2.39,Math.cos(t)*2.39,.01),M.rotation.set(0,0,-t),M.scale.set(1,e%5==0?2:.65,1),M.updateMatrix(),te.setMatrixAt(e,M.matrix)}F.instanceMatrix.needsUpdate=!0,te.instanceMatrix.needsUpdate=!0,P.add(F,te);let I=[];for(let e=0;e<12;e++){let t=document.createElement(`canvas`);t.width=128,t.height=64;let n=t.getContext(`2d`);n.font=`32px Georgia`,n.fillStyle=`#cfb780`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText([`XII`,`I`,`II`,`III`,`IV`,`V`,`VI`,`VII`,`VIII`,`IX`,`X`,`XI`][e],64,32);let r=new Pi(t);r.colorSpace=Fe,I.push(r);let i=new Z(new na(.32,.16),new zr({map:r,transparent:!0,side:2,depthWrite:!1,opacity:.8})),a=e/12*Au;i.position.set(Math.sin(a)*2.25,Math.cos(a)*2.25,.025),i.rotation.z=-a,P.add(i)}let ne=[];for(let e=0;e<4;e++){let t=new Y;ee.add(t),ne.push(t);let n=2.24-e*.29;N(n,.038+e*.002,e%2?_:g,t),N(n-.08,.018,v,t),N(n+.05,.009,_,t);let r=new Z(new zi(n,n,.1,144,1,!0),g);r.rotation.x=Math.PI/2,t.add(r);let i=new ci(new ia(.043,8,8),_,24);for(let e=0;e<24;e++){let t=e/24*Au;M.position.set(Math.cos(t)*n,Math.sin(t)*n,.06),M.rotation.set(0,0,0),M.scale.set(1,1,.6),M.updateMatrix(),i.setMatrixAt(e,M.matrix)}i.instanceMatrix.needsUpdate=!0,t.add(i);for(let e=0;e<2;e++){let r=new Z(new zi(.1,.1,.17,16),_);r.position.y=(e?1:-1)*n,t.add(r)}}let re=new Y;ee.add(re);let ie=new ga({uniforms:{uTime:{value:0},uColor:{value:new X(16758095)},uEra:{value:0}},vertexShader:`varying vec3 vPosition; varying vec3 vNormal; varying vec3 vView;
      void main(){vPosition=position;vNormal=normalize(normalMatrix*normal);vec4 p=modelViewMatrix*vec4(position,1.);vView=normalize(-p.xyz);gl_Position=projectionMatrix*p;}`,fragmentShader:`uniform float uTime;uniform vec3 uColor;uniform float uEra;varying vec3 vPosition;varying vec3 vNormal;varying vec3 vView;
      ...
      void main(){vec3 p=vPosition*5.;float n=noise(p+uTime*.11);n+=.5*noise(p*2.3-uTime*.18);n+=.25*noise(p*5.1+uTime*.15);float fissure=pow(1.-abs(sin(n*8.+vPosition.y*3.)),9.);float rim=pow(1.-max(0.,dot(normalize(vNormal),normalize(vView))),2.8);vec3 col=uColor*(.18+n*.28+fissure*2.4)+vec3(1.,.87,.65)*pow(fissure,3.)*1.4+uColor*rim*.8;gl_FragColor=vec4(col,1.);}`}),ae=new Z(new ia(.79,64,48),ie);re.add(ae);let oe=new Z(new ea(.91,1),new zr({color:15710826,wireframe:!0,transparent:!0,opacity:.15}));re.add(oe);let L=N(1.06,.018,_,re);L.rotation.x=1.1;let se=new Z(new ia(.86,40,32),new ga({uniforms:{uColor:ie.uniforms.uColor},transparent:!0,blending:2,depthWrite:!1,side:1,vertexShader:`varying vec3 n;varying vec3 v;void main(){n=normalize(normalMatrix*normal);vec4 p=modelViewMatrix*vec4(position,1.);v=normalize(-p.xyz);gl_Position=projectionMatrix*p;}`,fragmentShader:`uniform vec3 uColor;varying vec3 n;varying vec3 v;void main(){float a=pow(1.-abs(dot(n,v)),3.);gl_FragColor=vec4(uColor,a*.6);}`}));re.add(se);let ce=new Y;re.add(ce);let le=[16760168,9298899,11771135].map((e,t)=>{let n=new va({color:e,emissive:e,emissiveIntensity:1.25,metalness:.45,roughness:.18,transparent:!0,opacity:.92}),r=new Z(new aa(.24,0),n);r.userData.index=t,ce.add(r);let i=new Z(new aa(.31,0),new zr({color:e,wireframe:!0,transparent:!0,opacity:.35,depthWrite:!1,toneMapped:!1}));return r.add(i),r}),ue=new zr({color:14338469,transparent:!0,opacity:.18,blending:2,depthWrite:!1,toneMapped:!1}),de=N(1.3,.009,ue,re);de.rotation.set(1.18,.25,.1);let fe=new Y;ee.add(fe);let pe=new ta(.12,0);for(let e=0;e<12;e++){let t=new Z(pe,e%3?g:_),n=e/12*Au;t.position.set(Math.cos(n)*2.92,Math.sin(n)*2.92,Math.sin(n*3)*.3),t.scale.set(.6,1.3,.6),t.rotation.z=n+.4,fe.add(t)}let me=new Y;E.add(me);for(let e=0;e<3;e++)N(3+e*.12,.005,x,me,Au*.7).rotation.set(e*.8,.4+e*.6,e*1.5);let he=new Set([g,_,v,y]);P.traverse(e=>{e instanceof Z&&!Array.isArray(e.material)&&he.add(e.material)});let ge=vu(ee,[P,...ne],[...he]),_e=91837,ve=()=>(_e=_e*16807%2147483647,(_e-1)/2147483646),ye=new Float32Array(1400*3);for(let e=0;e<1400;e++)ye[e*3]=(ve()-.5)*36,ye[e*3+1]=(ve()-.5)*24,ye[e*3+2]=-3-ve()*22;let be=new Dr;be.setAttribute(`position`,new fr(ye,3));let xe=new Ei({color:13678729,size:.022,transparent:!0,opacity:.7,sizeAttenuation:!0,depthWrite:!1}),Se=new ji(be,xe);o.add(Se);let Ce=new Y;o.add(Ce);let we=new zr({color:10980704,transparent:!0,opacity:.055,depthWrite:!1});for(let e=0;e<5;e++){let t=N(4+e*.8,.008,we,Ce);t.rotation.x=.55,t.position.z=-4}let Te=new Z(new ia(14,28,16),new zr({color:8549207,wireframe:!0,transparent:!0,opacity:.025,side:1}));o.add(Te);let Ee=new Ao(55,65,7002818,2979690);Ee.position.set(0,-3.9,-9),Ee.material.transparent=!0,Ee.material.opacity=0,o.add(Ee);let De=new Y;o.add(De);let Oe=new zr({color:8417500,transparent:!0,opacity:0,wireframe:!0,depthWrite:!1}),ke=new Ri(.16,1,.16);for(let e=0;e<48;e++){let t=new Z(ke,Oe),n=e/48*Au;t.position.set(Math.cos(n)*(7+ve()*5),-3,Math.sin(n)*5-7),t.scale.y=2+ve()*9,De.add(t)}let Ae=1,R=1,je=`high`,Me=!1,Ne=!1,z=performance.now(),B=0,V=0,H=0,Pe=!1,Ie=0,Le=0,Re=0,ze=0,Be=0,Ve=0,He=0,Ue=0,We={position:0,velocity:0},Ge={position:0,velocity:0},Ke=ne.map(()=>({position:0,velocity:0})),qe=le.map((e,t)=>({position:+(t===0),velocity:0})),Je=!1,Ye=!1,Xe=0,U=0,W=!1,Ze=0,Qe=0,$e=1,et=0,tt=performance.now(),nt=new K,rt=new Do,it=new q,at=new jr(new q(0,0,1),-.8),G=new q,ot=0;function st(){Ae=e.clientWidth,R=e.clientHeight;let t=Math.min(window.devicePixelRatio||1,je===`high`?1.5:.85);O.setQuality(je,t),ge.setQuality(je===`low`,t),A.setQuality(je===`low`,t),a.setPixelRatio(t),d.setPixelRatio(t),a.setSize(Ae,R),d.setSize(Ae,R),s.aspect=Ae/R,s.updateProjectionMatrix();let n=Math.tan(Et.degToRad(19))*13.5,r=Ae<=700;E.position.x=r?0:n*s.aspect*.22,E.position.y=r?n*-.045:n*.24,E.scale.setScalar(r?Math.min(.43,Ae/920):Math.min(.87,Ae/1500)),Ce.position.copy(E.position),S.position.copy(E.position),S.position.z=1.2,h.uniforms.uAspect.value=Ae/R}let ct=new ResizeObserver(st);ct.observe(e),st();let lt=t=>{let n=e.getBoundingClientRect();nt.set((t.clientX-n.left)/n.width*2-1,-((t.clientY-n.top)/n.height)*2+1),Xe++},ut=r=>{if(!(r.button!==0&&r.pointerType!==`touch`||t.current.demo||![`explore`,`calibration`].includes(t.current.mode))){if(lt(r),t.current.mode===`calibration`){if(rt.setFromCamera(nt,s),ot=D.ringAt(rt)??t.current.selectedRing,t.current.locked[ot])return;n({type:`select`,ring:ot})}Pe=!0,Ie=r.clientX,Le=r.clientY,Ue=r.timeStamp,He=0,e.setPointerCapture(r.pointerId)}},dt=e=>{if(lt(e),!Pe||t.current.demo)return;let r=e.clientX-Ie,i=Math.max(.008,Math.min(.1,(e.timeStamp-Ue)/1e3));if(Ue=e.timeStamp,t.current.mode===`calibration`){if(t.current.locked[ot]){Pe=!1;return}n({type:`nudge`,degrees:r*.65})}else t.current.mode===`explore`&&(Re+=r*.006,ze=Math.max(-1.2,Math.min(1.2,ze+(e.clientY-Le)*.005)),He=Et.clamp(r*.006/i,-5,5),n({type:`nudge-time`,delta:r*.0015}));Ie=e.clientX,Le=e.clientY},ft=()=>{Pe=!1},pt=()=>{Pe=!1,He=0,U=Xe,A.breakStroke(),z=performance.now()},mt=e=>{t.current.mode!==`explore`||t.current.demo||(e.preventDefault(),n({type:`nudge-time`,delta:e.deltaY*.001}))};e.addEventListener(`pointerdown`,ut),e.addEventListener(`pointermove`,dt),e.addEventListener(`pointerup`,ft),e.addEventListener(`pointercancel`,ft),e.addEventListener(`wheel`,mt,{passive:!1}),e.addEventListener(`pointerleave`,pt),document.addEventListener(`visibilitychange`,pt);let ht=e=>{e.preventDefault(),pt(),Ne=!0,i(`3D временно приостановлено. Восстанавливаем артефакт…`)},gt=()=>{Ne=!1,i(``),st(),z=performance.now()};a.domElement.addEventListener(`webglcontextlost`,ht),a.domElement.addEventListener(`webglcontextrestored`,gt);let _t=[new X(15182934),new X(8445645),new X(10255871)],vt=[new X(11044433),new X(9939109),new X(9274293)],yt=new X;function bt(n){if(Me)return;let i=Math.min((n-z)/1e3,.05);if(z=n,Ne||document.hidden)return;let c=t.current,l=c.paused?0:i;Je&&=(V=c.time,H=+!!c.expanded,B=0,Ze=0,Re=ze=Be=Ve=He=0,We.position=We.velocity=Ge.position=Ge.velocity=0,Ke.forEach(e=>{e.position=e.velocity=0}),qe.forEach((e,t)=>{e.position=+(t<c.storyFragments),e.velocity=0}),$e=c.storyFragments,Qe=0,ge.reset(),D.reset(),A.reset(),j.reset(c.time),nt.set(0,0),U=Xe,!1),c.paused!==Ye&&(pt(),Ye=c.paused),Ae<=700&&E.scale.setScalar(Math.min(c.mode===`calibration`||c.mode===`syncing`?.35:.43,Ae/920));let u=c.mode===`calibration`||c.mode===`syncing`,f=c.mode===`syncing`?c.syncElapsed/8:0,m=c.mode===`beyond`,v=Math.max(0,Math.min(3,Math.round(c.storyFragments))),C=c.mode===`syncing`&&f>=.7;!c.reducedMotion&&!C&&(B+=l),Ze+=(+!!m-Ze)*(1-Math.exp(-l*(c.reducedMotion?2:1.5)));let w=c.reducedMotion?1:1-Math.exp(-l*2.5),T=V;V+=(c.time-V)*w,H+=(+!!c.expanded-H)*w,!Pe&&!c.reducedMotion&&(Re+=He*l,He*=Math.exp(-l*4.5)),c.reducedMotion?(We.position=Re,Ge.position=ze,We.velocity=Ge.velocity=0):(_u(We,Re,10,l),_u(Ge,ze,11,l)),Be=We.position,Ve=Ge.position,ee.visible=!m,ee.rotation.set(u?0:-.17+Ve,u?0:.2+Be+Math.sin(B*.06)*.25,u?0:-.25),ee.position.y=c.reducedMotion?0:Math.sin(B*.55)*.06,P.rotation.z=u?0:-B*.023,P.scale.setScalar(1+H*.15);for(let e=0;e<ne.length;e++){let t=ne[e];t.visible=!u,_u(Ke[e],Be*.55,3.5+e*1.25,l);let n=c.reducedMotion?0:Et.clamp(Ke[e].position-Be*.55,-.65,.65);t.rotation.set(.5+e*.57+Math.sin(B*.12+e)*.14+V*.5+n*.4,e*.86+B*(e%2?-.035:.045)+n,e*.7+B*.03+n*(e%2?.6:-.6)),t.position.y=H*(e-1.5)*.7,t.position.z=H*(e%2?.75:-.75),t.scale.setScalar(1+H*.08+Math.max(0,V-1)*.05)}fe.rotation.z=B*.055,fe.visible=!u,v>$e&&(Qe=1),$e=v,Qe=Math.max(0,Qe-l*1.25),ce.visible=!m,ce.rotation.z=B*.16,le.forEach((e,t)=>{_u(qe[t],+(t<v),8.5+t,l);let n=Et.clamp(qe[t].position,0,1),r=-Math.PI/2+t*Au/3,i=Et.lerp(3.35,1.3,n);e.visible=n>.015,e.position.set(Math.cos(r)*i,Math.sin(r)*i,Math.sin(r*2)*.18);let a=t===v-1?Qe:0;e.scale.setScalar(Math.max(.001,n)*(1+a*(c.reducedMotion?.12:.42))),e.rotation.set(B*(.45+t*.08),r+B*.22,-r)}),ue.opacity=.08+v*.055+Qe*.22,de.rotation.z=-B*.12;let M=j.update(V,B,l,c.mode===`explore`,c.reducedMotion),N=D.update(c,B,c.reducedMotion,l),F=k.update(c.mode===`syncing`?c.syncElapsed:0,c.reducedMotion);O.update(m,c.reducedMotion?Math.max(.35,Ze):Ze,B,nt,c.reducedMotion,c.paused,l,c.ending);let te=c.reducedMotion?13.5:13.5-Math.sin(f*Math.PI*.5)*1.6;s.position.z+=(te-s.position.z)*(c.reducedMotion?1:1-Math.exp(-l*4)),re.scale.setScalar((1+(c.reducedMotion?Qe*.03:Math.sin(f*Math.PI)*.3+N*.09+Qe*.05))*(1-F*.72)),D.group.scale.setScalar(1+F*.3),P.scale.multiplyScalar(1+F*.24),E.getWorldPosition(it),it.project(s),h.uniforms.uCenter.value.set(it.x*.5+.5,it.y*.5+.5),h.uniforms.uProgress.value=Math.max(0,(f-.35)/.65),h.uniforms.uStrength.value=+!c.reducedMotion,h.uniforms.uFracture.value=F,h.enabled=f>.35&&!c.reducedMotion,fe.scale.setScalar(.94+H*.2+V*.06),me.rotation.set(B*.045,B*.06,B*.025),x.opacity=m?0:Math.max(0,V-.65)*.65+f*.5,ae.rotation.y=B*.09,ie.uniforms.uTime.value=B,ie.uniforms.uEra.value=V;let I=Math.min(1,Math.floor(V)),L=V-I;yt.copy(_t[I]).lerp(_t[I+1],L),ie.uniforms.uColor.value.copy(yt),ie.uniforms.uColor.value.multiplyScalar(1+N*(c.reducedMotion?.15:.9)+F*.6+Qe*.4),S.color.copy(yt),b.color.copy(yt),x.color.copy(yt),xe.color.copy(yt),y.color.copy(yt),g.color.copy(vt[I]).lerp(vt[I+1],L),_.color.copy(g.color).lerp(yt,.25);let se=ge.update(V,B,c.mode===`explore`,c.reducedMotion,yt)??0;E.updateMatrixWorld(!0),s.updateMatrixWorld(!0),rt.setFromCamera(nt,s),rt.ray.intersectPlane(at,G)&&E.worldToLocal(G);let pe=A.update(m,G,U!==Xe,l,c.reducedMotion);U=Xe,g.roughness=.3-V*.04,oe.rotation.y=-B*.12,oe.material.opacity=.12+V*.15,Se.rotation.y=B*.008,Ce.rotation.z=B*.01,we.color.copy(yt),Ee.material.opacity=m?0:Math.sin(V/2*Math.PI)*.09,Oe.opacity=m?0:Math.max(0,V-1)*.055,De.rotation.y=B*.008,p.strength=m?.48:.26+V*.08+f*.4+N*.25+Qe*.22+Math.min(.15,Math.abs(T-V)*4),je===`low`?a.render(o,s):d.render(),W||(W=!0,r()),et++,n-tt>=2e3&&(e.dataset.fps=String(Math.round(et*1e3/(n-tt))),e.dataset.tracePoints=String(pe),e.dataset.dissolution=se.toFixed(2),e.dataset.storyFragments=String(v),e.dataset.storyDiorama=[`past`,`present`,`future`][M.era],e.dataset.storyAge=M.age.toFixed(1),e.dataset.geometries=String(a.info.memory.geometries),et=0,tt=n)}return a.setAnimationLoop(bt),{reset(){Je=!0,pt()},setQuality(e){je=e,st()},dispose(){Me=!0,a.setAnimationLoop(null),ct.disconnect(),e.removeEventListener(`pointerdown`,ut),e.removeEventListener(`pointermove`,dt),e.removeEventListener(`pointerup`,ft),e.removeEventListener(`pointercancel`,ft),e.removeEventListener(`wheel`,mt),e.removeEventListener(`pointerleave`,pt),document.removeEventListener(`visibilitychange`,pt),a.domElement.removeEventListener(`webglcontextlost`,ht),a.domElement.removeEventListener(`webglcontextrestored`,gt);let t=new Set,n=new Set;o.traverse(e=>{let r=e;r.geometry&&t.add(r.geometry),r.material&&(Array.isArray(r.material)?r.material:[r.material]).forEach(e=>n.add(e)),e instanceof ci&&e.dispose()}),t.forEach(e=>e.dispose()),n.forEach(e=>e.dispose()),I.forEach(e=>e.dispose()),b.dispose(),u.dispose(),p.dispose(),h.dispose(),m.dispose(),f.dispose(),d.dispose(),a.dispose(),a.domElement.remove()}}}export{ju as createArtifact};
//# sourceMappingURL=artifact-engine-CFTXbuw_.js.map
